...
public class GoodsTypeBean implements Serializable{
	...
	private List<GoodsTypeSub> tgoodsTypeSubList;
	...
	public List<GoodsTypeSub> getTgoodsTypeSubList() {
		return tgoodsTypeSubList;
	}
	public void setTgoodsTypeSubList(List<GoodsTypeSub> tgoodsTypeSubList) {
