...
*用户聊天记录，用户id分表
**/
public class TUserMessage5 extends BaseModel implements Serializable{
	...
	public TUserMessage5(){
 	}
 	public TUserMessage5(Integer id,Integer userId,Integer receiveUserId,String content,Integer type,Integer valNum,Integer readIs){
 		this.id = id;
		this.userId = userId;
