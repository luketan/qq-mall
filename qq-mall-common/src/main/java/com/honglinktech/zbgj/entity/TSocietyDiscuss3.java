...
*
**/
public class TSocietyDiscuss3 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss3(){
 	}
 	public TSocietyDiscuss3(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
