...
*回帖内容，根据帖子id，分表
**/
public class TSocietyDiscuss0 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss0(){
 	}
 	public TSocietyDiscuss0(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
