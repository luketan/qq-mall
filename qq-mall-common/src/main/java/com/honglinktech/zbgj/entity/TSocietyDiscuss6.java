...
*
**/
public class TSocietyDiscuss6 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss6(){
 	}
 	public TSocietyDiscuss6(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
