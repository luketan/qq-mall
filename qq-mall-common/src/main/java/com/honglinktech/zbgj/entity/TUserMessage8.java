...
*用户聊天记录，用户id分表
**/
public class TUserMessage8 extends BaseModel implements Serializable{
	...
	public TUserMessage8(){
 	}
 	public TUserMessage8(Integer id,Integer userId,Integer receiveUserId,String content,Integer type,Integer valNum,Integer readIs){
 		this.id = id;
		this.userId = userId;
