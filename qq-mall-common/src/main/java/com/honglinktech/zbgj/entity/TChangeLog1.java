...
**/
public class TChangeLog1 extends BaseModel implements Serializable{
	...
	public TChangeLog1(){
 	...
 	public TChangeLog1(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
