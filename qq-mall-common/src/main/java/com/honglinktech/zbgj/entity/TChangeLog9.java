...
**/
public class TChangeLog9 extends BaseModel implements Serializable{
	...
	public TChangeLog9(){
 	...
 	public TChangeLog9(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
