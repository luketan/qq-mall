...
*
**/
public class TSocietyDiscuss7 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss7(){
 	}
 	public TSocietyDiscuss7(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
