...
*
**/
public class TUserSocMessage5 extends BaseModel implements Serializable{
	...
	public TUserSocMessage5(){
 	}
 	public TUserSocMessage5(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
