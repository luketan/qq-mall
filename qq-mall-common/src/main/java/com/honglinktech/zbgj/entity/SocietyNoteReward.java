...
*社区打赏
**/
public class SocietyNoteReward extends BaseEntity implements Serializable{
	...
	public SocietyNoteReward(){
 	}
 	public SocietyNoteReward(Integer id,Integer societyNoteId,Integer userId,Integer busUserId,Integer type,Integer valNum){
 		this.id = id;
	...
	public enum DBMaping{
		tableName("t_society_note_reward",0,false,false,false),
	...
	public static class TSocietyNoteRewardRowMapper implements RowMapper<SocietyNoteReward> {  
        @Override  
        public SocietyNoteReward mapRow(ResultSet rs, int rowNum) throws SQLException {  

			SocietyNoteReward tSocietyNoteReward = new SocietyNoteReward();
