...
*
**/
public class TSocietyDiscuss8 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss8(){
 	}
 	public TSocietyDiscuss8(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
