...
*
**/
public class TUserSocMessage7 extends BaseModel implements Serializable{
	...
	public TUserSocMessage7(){
 	}
 	public TUserSocMessage7(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
