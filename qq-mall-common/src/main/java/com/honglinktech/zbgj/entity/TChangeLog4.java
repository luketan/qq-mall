...
**/
public class TChangeLog4 extends BaseModel implements Serializable{
	...
	public TChangeLog4(){
 	...
 	public TChangeLog4(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
