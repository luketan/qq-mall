...
*用户关注的主题
**/
public class TSocietySubjectUser extends BaseModel implements Serializable{
	...
	public TSocietySubjectUser(){
 	}
 	public TSocietySubjectUser(Integer societySubjectId,Integer userId,Integer val,Integer type){
