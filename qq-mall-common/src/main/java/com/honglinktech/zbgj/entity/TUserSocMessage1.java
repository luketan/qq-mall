...
*
**/
public class TUserSocMessage1 extends BaseModel implements Serializable{
	...
	public TUserSocMessage1(){
 	}
 	public TUserSocMessage1(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
