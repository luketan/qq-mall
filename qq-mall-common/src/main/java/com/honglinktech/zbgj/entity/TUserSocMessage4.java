...
*
**/
public class TUserSocMessage4 extends BaseModel implements Serializable{
	...
	public TUserSocMessage4(){
 	}
 	public TUserSocMessage4(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
