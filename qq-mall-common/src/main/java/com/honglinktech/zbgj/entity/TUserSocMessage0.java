...
*
**/
public class TUserSocMessage0 extends BaseModel implements Serializable{
	...
	public TUserSocMessage0(){
 	}
 	public TUserSocMessage0(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
