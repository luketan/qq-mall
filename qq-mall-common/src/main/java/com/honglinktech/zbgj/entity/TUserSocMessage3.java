...
*
**/
public class TUserSocMessage3 extends BaseModel implements Serializable{
	...
	public TUserSocMessage3(){
 	}
 	public TUserSocMessage3(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
