...
*
**/
public class TUserSocMessage9 extends BaseModel implements Serializable{
	...
	public TUserSocMessage9(){
 	}
 	public TUserSocMessage9(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
