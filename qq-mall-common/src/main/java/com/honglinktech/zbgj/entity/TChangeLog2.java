...
**/
public class TChangeLog2 extends BaseModel implements Serializable{
	...
	public TChangeLog2(){
 	...
 	public TChangeLog2(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
