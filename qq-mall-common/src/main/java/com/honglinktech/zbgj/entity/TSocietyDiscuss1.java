...
*
**/
public class TSocietyDiscuss1 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss1(){
 	}
 	public TSocietyDiscuss1(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
