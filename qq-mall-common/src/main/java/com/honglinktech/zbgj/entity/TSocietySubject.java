...
*
**/
public class TSocietySubject extends BaseModel implements Serializable{
	...
	public TSocietySubject(){
 	}
 	public TSocietySubject(Integer id,String name,String icon,String synopsis,Integer type,Integer status,Integer sort,Integer hotNum,Integer awardType,Integer awardNum){
 		this.id = id;
		this.name = name;
		this.icon = icon;
