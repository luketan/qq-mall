...
**/
public class TChangeLog5 extends BaseModel implements Serializable{
	...
	public TChangeLog5(){
 	...
 	public TChangeLog5(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
