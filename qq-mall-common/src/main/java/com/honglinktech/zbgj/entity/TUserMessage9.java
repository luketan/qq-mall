...
*用户聊天记录，用户id分表
**/
public class TUserMessage9 extends BaseModel implements Serializable{
	...
	public TUserMessage9(){
 	}
 	public TUserMessage9(Integer id,Integer userId,Integer receiveUserId,String content,Integer type,Integer valNum,Integer readIs){
 		this.id = id;
		this.userId = userId;
