...
*
**/
public class TUserSocMessage8 extends BaseModel implements Serializable{
	...
	public TUserSocMessage8(){
 	}
 	public TUserSocMessage8(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
