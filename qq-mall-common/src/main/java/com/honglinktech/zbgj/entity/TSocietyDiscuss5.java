...
*
**/
public class TSocietyDiscuss5 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss5(){
 	}
 	public TSocietyDiscuss5(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
