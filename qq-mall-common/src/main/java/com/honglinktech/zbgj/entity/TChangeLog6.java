...
**/
public class TChangeLog6 extends BaseModel implements Serializable{
	...
	public TChangeLog6(){
 	...
 	public TChangeLog6(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
