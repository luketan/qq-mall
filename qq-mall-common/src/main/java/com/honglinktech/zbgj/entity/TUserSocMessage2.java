...
*
**/
public class TUserSocMessage2 extends BaseModel implements Serializable{
	...
	public TUserSocMessage2(){
 	}
 	public TUserSocMessage2(Integer id,Integer societyNoteId,Integer userId,Integer type,String content){
 		this.id = id;
