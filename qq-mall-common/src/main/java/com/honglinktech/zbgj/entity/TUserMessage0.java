...
*用户聊天记录，用户id分表
**/
public class TUserMessage0 extends BaseModel implements Serializable{
	...
	public TUserMessage0(){
 	}
 	public TUserMessage0(Integer id,Integer userId,Integer receiveUserId,String content,Integer type,Integer valNum,Integer readIs){
 		this.id = id;
		this.userId = userId;
