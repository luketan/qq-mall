...
*商品评论表
**/
public class TGoodsDiscuss extends BaseModel implements Serializable{
	...
	public TGoodsDiscuss(){
 	}
 	public TGoodsDiscuss(Integer id,Integer goodsId,Integer userId,String userName,Integer goodsFormatId,String goodsFormat,String content,String typeValue,Integer discussValue){
 		this.id = id;
