...
**/
public class TChangeLog0 extends BaseModel implements Serializable{
	...
	public TChangeLog0(){
 	...
 	public TChangeLog0(Integer id,Integer teamId,Integer objectId,Integer type,Integer logType,Integer beforeNum,Integer num,Integer currNum,Integer level,String comments){
 		this.id = id;
		this.teamId = teamId;
