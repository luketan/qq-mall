...
*用户聊天记录，用户id分表
**/
public class TUserMessage6 extends BaseModel implements Serializable{
	...
	public TUserMessage6(){
 	}
 	public TUserMessage6(Integer id,Integer userId,Integer receiveUserId,String content,Integer type,Integer valNum,Integer readIs){
 		this.id = id;
		this.userId = userId;
