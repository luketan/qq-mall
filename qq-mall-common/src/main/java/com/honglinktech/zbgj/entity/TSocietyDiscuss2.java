...
*
**/
public class TSocietyDiscuss2 extends BaseModel implements Serializable{
	...
	public TSocietyDiscuss2(){
 	}
 	public TSocietyDiscuss2(Integer id,Integer societyNoteId,Integer userId,String userName,String content,String likeUser,Integer parent,Integer replyUserId,String replyUserName){
 		this.id = id;
