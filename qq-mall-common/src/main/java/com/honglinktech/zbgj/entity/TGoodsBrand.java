...
*商品品牌
**/
public class TGoodsBrand extends BaseEntity implements Serializable{
	...
	public TGoodsBrand(){
 	...
 	public TGoodsBrand(Integer id,String name,Integer goodsType,String typeName,Integer status){
 		this.id = id;
		this.name = name;
	...
	public enum DBMaping{
		tableName("t_goods_brand",0,false,false,false),
	...
	public static class TGoodsBrandRowMapper implements RowMapper<TGoodsBrand> {  
        @Override  
        public TGoodsBrand mapRow(ResultSet rs, int rowNum) throws SQLException {  

			TGoodsBrand tGoodsBrand = new TGoodsBrand();
			tGoodsBrand.setId(rs.getInt("id"));
			tGoodsBrand.setName(rs.getString("name"));
			tGoodsBrand.setGoodsType(rs.getInt("goods_type"));
			tGoodsBrand.setTypeName(rs.getString("type_name"));
			tGoodsBrand.setStatus(rs.getInt("status"));
			tGoodsBrand.setCreateTime(rs.getTimestamp("create_time"));
			tGoodsBrand.setUpdateTime(rs.getTimestamp("update_time"));
			return tGoodsBrand; 
        }  
