...
import com.honglinktech.zbgj.dao.TPaymentUserDao;
...
import com.honglinktech.zbgj.dao.self.PaymentDao;
...
public class OrderService extends TOrderService {
	...
	@Resource
	private TPaymentUserDao tpaymentUserDao;
	@Resource
...
//		List<TOrderItemFormat> torderItemFormats = new ArrayList<TOrderItemFormat>();
//		List<TOrderActivity> torderActivitys = new ArrayList<TOrderActivity>();
		//优惠券-筛选可用的购物券
		//每种类型的商品总价格
		Map<String,BigDecimal> goodsTypeValueMap = new HashMap<String, BigDecimal>();
		//商品总价格
	...
	public Response<List<TPostDetail>> appFindPostDetail(String postCode) {
		Map<String, String[]> whereMap = new HashMap<String, String[]>();
		whereMap.put(TPostDetail.DBMaping.postCode.name(), new String[]{postCode});
		whereMap.put(TPostDetail.DBMaping.deleteFlag.name(), new String[]{"N"});
