...
@Component
public class GoodsDisService extends TGoodsDisService {
	@Resource
	...
	public Response<GoodsDisCountBean> findGoodsDisCount(int goodsId){
		...
		Map<String, Object> map = tgoodsDisDao.findMap(sql);
	...
	public Response<List<GoodsDisBean>> findGoodsDisByPage(Map<String, String> map) throws BaseException{
		...
		QueryHelper<TGoodsDis> resutlQH = tgoodsDisDao.findByQueryHelperNoCount(qh);
