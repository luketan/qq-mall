...
*
**/
public class SocietySubTypeBean extends BaseEntity implements Serializable{
	...
	public static class SocietySubRowMapper implements RowMapper<SocietySubTypeBean> {
        @Override  
        public SocietySubTypeBean mapRow(ResultSet rs, int rowNum) throws SQLException {

			SocietySubTypeBean tSocietySub = new SocietySubTypeBean();
	...
	public static class SocietySubUserRowMapper implements RowMapper<SocietySubTypeBean> {
        @Override  
        public SocietySubTypeBean mapRow(ResultSet rs, int rowNum) throws SQLException {
