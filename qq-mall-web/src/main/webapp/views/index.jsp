    ...
    <div class="slideall" style="height: auto;">
        ...
        <div class="bannerTwo">
            ...
            <div class="am-slider am-slider-default scoll" data-am-flexslider id="demo-slider-0">
                <ul class="am-slides">
                    <li class="banner1"><a href="introduction.html"><img src="${statics}/images/ad5.jpg" /></a></li>
                    <li class="banner2"><a><img src="${statics}/images/ad6.jpg" /></a></li>
                    <li class="banner3"><a><img src="${statics}/images/ad7.jpg" /></a></li>
                    <li class="banner4"><a><img src="${statics}/images/ad8.jpg" /></a></li>
                </ul>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="am-g am-g-fixed smallnav">
            <div class="am-u-sm-3">
                <a href="sort.html"><img src="${statics}/images/navsmall.jpg" />
        ...
        <!--各类活动-->
        <div class="row">
            <li><a><img src="${statics}/images/row1.jpg"/></a></li>
            <li><a><img src="${statics}/images/row2.jpg"/></a></li>
            <li><a><img src="${statics}/images/row3.jpg"/></a></li>
            <li><a><img src="${statics}/images/row4.jpg"/></a></li>
        </div>
        <div class="clear"></div>
        <!--走马灯 -->
        ...
        <div class="am-container">
            ...
            <div class="am-g am-g-fixed sale">
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${statics}/images/sale3.jpg" /></a>
                    </div>
                    <div class="s-info">
                ...
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${statics}/images/sale2.jpg" /></a>
                    </div>
                    <div class="s-info">
                        <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                        <div class="s-price">￥<b>9.90</b>
                ...
                <div class="am-u-sm-3 sale-item">
                    <div class="s-img">
                        <a href="# "><img src="${statics}/images/sale1.jpg" /></a>
                    </div>
                    <div class="s-info">
                        <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
                        <div class="s-price">￥<b>9.90</b>
        ...
        <div class="f1">
            ...
            <div class="am-g am-g-fixed floodSix ">
                ...
                <div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
                    ...
                    <a href="# "><img src="${statics}/images/act1.png" /></a>
                </div>
                ...
                <li>
                    <div class="am-u-md-2 am-u-lg-2 text-three">
                        ...
                        <a href="# "><img src="${statics}/images/1.jpg " /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-md-2 am-u-lg-2 text-three sug">
                        ...
                        <a href="# "><img src="${statics}/images/2.jpg " /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-4 am-u-md-5 am-u-lg-4 text-five">
                        ...
                        <a href="# "><img src="${statics}/images/5.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-4 am-u-md-2 am-u-lg-2 text-six">
                        ...
                        <a href="# "><img src="${statics}/images/3.jpg" /></a>
                    </div>
                </li>
                <li>
        ...
        <div class="f2">
            ...
            <div class="am-g am-g-fixed floodSeven">
                ...
                <div class="am-u-sm-7 am-u-md-4 text-two big">
                    ...
                    <a href="# "><img src="${statics}/images/act2.png " /></a>
                ...
                <li>
                    <div class="am-u-sm-7 am-u-md-4 text-two">
                        ...
                        <a href="# "><img src="${statics}/images/6.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three sug">
                        ...
                        <a href="# "><img src="${statics}/images/7.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three big">
                        ...
                        <a href="# "><img src="${statics}/images/10.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three ">
                        ...
                        <a href="# "><img src="${statics}/images/8.jpg" /></a>
                    </div>
                </li>
                <li>
                    <div class="am-u-sm-3 am-u-md-2 text-three ">
                        ...
                        <a href="# "><img src="${statics}/images/9.jpg" /></a>
                    </div>
                </li>
            </div>
            <div class="clear "></div>
...
<div class="navCir">
    ...
    <li><a href="${statics}/person/index.html"><i class="am-icon-user"></i>我的</a></li>
</div>
<!--菜单 -->
<div class=tip>
    <div id="sidebar">
        <div id="wrap">
            ...
            <div id="broadcast " class="item ">
                <a href="# ">
                    <span class="chongzhi "><img src="${statics}/images/chongzhi.png " /></span>
                </a>
                <div class="mp_tooltip ">
                    我要充值
                    <i class="icon_arrow_right_black "></i>
            ...
            <div class="quick_toggle ">
                ...
                <li class="qtitem ">
                    ...
                    <div class="mp_qrcode " style="display:none; "><img src="${statics}/images/weixin_code_145.png " /><i class="icon_arrow_white "></i></div>
                </li>
                <li class="qtitem ">
