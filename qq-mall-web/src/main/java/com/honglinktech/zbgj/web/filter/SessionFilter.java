...
public class SessionFilter implements Filter {
    ...
    public void init(FilterConfig cfg) throws ServletException {
        ...
        //String excepUrlRegex = cfg.getInitParameter("excepUrlRegex")';// /servlets/(login|regist)Servlet
        String excepUrlRegex = "/user/";
        if (!StringUtils.isEmpty(excepUrlRegex)) {
            excepUrlPattern = Pattern.compile(excepUrlRegex);
        }
        //forwardUrl = cfg.getInitParameter("forwardUrl");
        forwardUrl = "login.html";
    }
...
//         * request.getQueryString()：a=1&b=2
        ...
        if (sessionObj == null) {
            ...
            String redirect = servletPath + "?" + request.getQueryString();
            /*
             ...
             *  }
             */
            response.sendRedirect(contextPath + (StringUtils.isEmpty(forwardUrl)?"/":forwardUrl)
