...
CREATE TABLE `c_admin` (
  ...
  `password` varchar(20) CHARACTER SET latin1 NOT NULL DEFAULT '' COMMENT '密码',
  `email` varchar(50) DEFAULT NULL,
  `phone` varchar(20) DEFAULT NULL,
  `status` int(1) DEFAULT '1' COMMENT '管理员状态',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COMMENT='管理员表';

-- ----------------------------
-- Records of c_admin
-- ----------------------------
INSERT INTO `c_admin` VALUES ('1', 'luke', 'luke', 'luke123456', 'luke@123.com', null, '1', '2016-03-06 23:20:36', '2015-12-25 01:13:15');
INSERT INTO `c_admin` VALUES ('2', 'weixin', 'weixin', 'weixin123456', null, null, '1', '2016-03-06 17:49:55', '2015-12-25 01:13:30');
INSERT INTO `c_admin` VALUES ('72', 'test', 'test', 'test', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('73', 'terst', 'etst ', 'test', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('74', 'test', 'erwerwer', 'erwerwer', null, null, '1', '2016-03-06 17:48:25', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('75', 'test1', 'test1', 'test1', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('76', 'rdydr', '3454', '345345', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('77', '3454', '345345', '3453454', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('78', '7567567', '576756', '567567', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('79', '12312', '65645', '56867867', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('80', '23423', '234234', '23423423', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('81', '56756', '768979', '879789', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('82', '12312', '456456', '78678', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('83', '678678', '6786789', '456456', null, null, '1', '1979-01-01 01:00:00', '1979-01-01 01:00:00');
INSERT INTO `c_admin` VALUES ('85', 'jack', 'jack', '123456', 'jack@qq.com', '18666668629', '1', '2016-03-06 23:51:43', '2016-03-06 21:30:02');
...
CREATE TABLE `c_admin_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_user_role_id_uindex` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='用户角色关联表';

-- ----------------------------
-- Records of c_admin_role
-- ----------------------------
INSERT INTO `c_admin_role` VALUES ('1', '80407453', '1');
INSERT INTO `c_admin_role` VALUES ('2', '60459303', '1');
INSERT INTO `c_admin_role` VALUES ('4', '66864925', '1');
INSERT INTO `c_admin_role` VALUES ('5', '18189615', '2');
INSERT INTO `c_admin_role` VALUES ('6', '68587186', '1');
INSERT INTO `c_admin_role` VALUES ('12', '1', '1');
INSERT INTO `c_admin_role` VALUES ('13', '1', '2');
INSERT INTO `c_admin_role` VALUES ('14', '48530929', '3');

-- ----------------------------
-- Table structure for `c_admin_session`
-- ----------------------------
DROP TABLE IF EXISTS `c_admin_session`;
CREATE TABLE `c_admin_session` (
  `admin_id` int(10) NOT NULL COMMENT '用户Id',
  `token` varchar(100) NOT NULL COMMENT '访问标识',
  `update_time` timestamp NULL DEFAULT '1970-01-01 12:00:00' COMMENT '更新时间',
  `create_time` timestamp NULL DEFAULT '1970-01-01 12:00:00' COMMENT '创建时间',
  PRIMARY KEY (`admin_id`),
  KEY `idx_team_id` (`admin_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='管理员回话信息';

-- ----------------------------
-- Records of c_admin_session
-- ----------------------------
INSERT INTO `c_admin_session` VALUES ('1', 'jgdAe3co2wuuYkzhno6FshFB%2FEKBdUQSUGcta2xLwhgKRaHXiGc8QeOFz%2Ff1kOz9yJgKSFboyIQ%3D', '2016-03-07 22:24:37', '2016-03-06 14:55:59');

-- ----------------------------
-- Table structure for `c_admin_session_log`
-- ----------------------------
DROP TABLE IF EXISTS `c_admin_session_log`;
CREATE TABLE `c_admin_session_log` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) NOT NULL COMMENT '用户Id',
  `token` varchar(100) NOT NULL COMMENT '访问标识',
  `login_ip` varchar(64) DEFAULT NULL COMMENT 'IP',
  `form` int(1) DEFAULT NULL COMMENT '1是ios，2是Android，3是微信，4是pc',
  `type` int(4) unsigned DEFAULT '0' COMMENT '类型[登入：1，登出：2]',
  `unique` varchar(64) DEFAULT NULL,
  `create_time` timestamp NULL DEFAULT '1970-01-01 12:00:00' COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_team_id` (`admin_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='登录日志表';

-- ----------------------------
-- Records of c_admin_session_log
-- ----------------------------
INSERT INTO `c_admin_session_log` VALUES ('4', '1', 'bCvKcjLkhH0RFL8AiV7bVeDhxqt2ZB81mUW7CnRK8RSUDud6g6sp3Q%3D%3D', '127.0.0.1', '2', '1', null, '2016-03-02 00:14:39');
INSERT INTO `c_admin_session_log` VALUES ('5', '1', 'bCvKcjLkhH0ejIT%2Bc35hQbO4ToMyU1nxiFWox0RpAJqUDud6g6sp3Q%3D%3D', '127.0.0.1', '1', '1', null, '2016-03-02 00:15:25');
INSERT INTO `c_admin_session_log` VALUES ('6', '1', 'bCvKcjLkhH0ejIT%2Bc35hQah8X9w7Pc6A5aBL1NUinbmUDud6g6sp3Q%3D%3D', '127.0.0.1', '1', '1', null, '2016-03-02 00:15:27');
INSERT INTO `c_admin_session_log` VALUES ('7', '1', 'bCvKcjLkhH0Js5quyQeimbqpDxmRbg9T5aBL1NUinbmUDud6g6sp3Q%3D%3D', '127.0.0.1', '1', '1', null, '2016-03-02 00:20:21');
INSERT INTO `c_admin_session_log` VALUES ('8', '1', 'bCvKcjLkhH0PCpvdCD5WyZE%2B9tf%2BqLnG5aBL1NUinbmUDud6g6sp3Q%3D%3D', '127.0.0.1', '1', '1', null, '2016-03-02 00:21:46');
INSERT INTO `c_admin_session_log` VALUES ('9', '1', 'bCvKcjLkhH0KsASD6%2FjNv1CFxINSxFkNRdIQqq1d7piUDud6g6sp3Q%3D%3D', '127.0.0.1', '0', '1', null, '2016-03-02 00:27:34');
INSERT INTO `c_admin_session_log` VALUES ('10', '1', 'bCvKcjLkhH0KsASD6%2FjNv%2Ftr%2FcLSCUxN%2BFUJKjBSebmUDud6g6sp3Q%3D%3D', '127.0.0.1', '0', '1', null, '2016-03-02 00:28:06');
INSERT INTO `c_admin_session_log` VALUES ('11', '1', 'jgdAe3co2wuOGzuN%2FK7oaUUealaA19Ou%2BFUJKjBSebmUDud6g6sp3Q%3D%3D', '0:0:0:0:0:0:0:1', '0', '1', null, '2016-03-06 14:55:59');
INSERT INTO `c_admin_session_log` VALUES ('12', '1', 'jgdAe3co2wud2%2BidyJAPO%2FTeiq051HWp5aBL1NUinbmUDud6g6sp3Q%3D%3D', '0:0:0:0:0:0:0:1', '0', '1', null, '2016-03-06 15:09:18');
INSERT INTO `c_admin_session_log` VALUES ('13', '1', 'jgdAe3co2wud2%2BidyJAPOwTTf5VpuZTCMPHrep0ZYGaUDud6g6sp3Q%3D%3D', '0:0:0:0:0:0:0:1', '0', '1', null, '2016-03-06 15:09:36');
INSERT INTO `c_admin_session_log` VALUES ('14', '1', 'jgdAe3co2ws7g3jLzKF4oN%2FmaOiDnBNmmbY0KgIAEsyUDud6g6sp3Q%3D%3D', '0:0:0:0:0:0:0:1', '0', '1', null, '2016-03-06 15:15:13');
INSERT INTO `c_admin_session_log` VALUES ('15', '1', 'jgdAe3co2wuZbrLH22NI5AtONPm6ENML%2Bi9L4tQTvDkKRaHXiGc8QeOFz%2Ff1kOz9yJgKSFboyIQ%3D', '0:0:0:0:0:0:0:1', '0', '1', null, '2016-03-06 17:10:53');
INSERT INTO `c_admin_session_log` VALUES ('16', '1', 'jgdAe3co2wuuYkzhno6FshFB%2FEKBdUQSUGcta2xLwhgKRaHXiGc8QeOFz%2Ff1kOz9yJgKSFboyIQ%3D', '0:0:0:0:0:0:0:1', '0', '1', null, '2016-03-07 22:24:37');
...
CREATE TABLE `c_role` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_role_id_uindex` (`id`)
...
CREATE TABLE `c_role_security` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `tb_role_security_id_uindex` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8 COMMENT='角色权限关联表';

-- ----------------------------
-- Records of c_role_security
-- ----------------------------
INSERT INTO `c_role_security` VALUES ('77', '2', '2');
INSERT INTO `c_role_security` VALUES ('78', '2', '26');
INSERT INTO `c_role_security` VALUES ('79', '2', '27');
INSERT INTO `c_role_security` VALUES ('80', '2', '28');
INSERT INTO `c_role_security` VALUES ('81', '2', '29');
INSERT INTO `c_role_security` VALUES ('82', '3', '6');
INSERT INTO `c_role_security` VALUES ('83', '3', '8');
INSERT INTO `c_role_security` VALUES ('84', '3', '9');
INSERT INTO `c_role_security` VALUES ('85', '3', '30');
INSERT INTO `c_role_security` VALUES ('86', '3', '16');
INSERT INTO `c_role_security` VALUES ('87', '3', '18');
INSERT INTO `c_role_security` VALUES ('88', '3', '36');
INSERT INTO `c_role_security` VALUES ('89', '3', '5');
INSERT INTO `c_role_security` VALUES ('90', '3', '22');
INSERT INTO `c_role_security` VALUES ('91', '3', '31');
INSERT INTO `c_role_security` VALUES ('94', '1', '1');
INSERT INTO `c_role_security` VALUES ('95', '1', '2');
INSERT INTO `c_role_security` VALUES ('96', '1', '3');
INSERT INTO `c_role_security` VALUES ('97', '1', '4');
INSERT INTO `c_role_security` VALUES ('98', '1', '5');
INSERT INTO `c_role_security` VALUES ('99', '1', '6');
INSERT INTO `c_role_security` VALUES ('100', '1', '7');
INSERT INTO `c_role_security` VALUES ('101', '1', '8');
INSERT INTO `c_role_security` VALUES ('102', '1', '9');
INSERT INTO `c_role_security` VALUES ('103', '1', '10');
INSERT INTO `c_role_security` VALUES ('104', '1', '11');
INSERT INTO `c_role_security` VALUES ('105', '1', '12');
INSERT INTO `c_role_security` VALUES ('106', '1', '13');
INSERT INTO `c_role_security` VALUES ('107', '1', '14');
INSERT INTO `c_role_security` VALUES ('108', '1', '15');
INSERT INTO `c_role_security` VALUES ('109', '1', '16');
INSERT INTO `c_role_security` VALUES ('110', '1', '17');
INSERT INTO `c_role_security` VALUES ('111', '1', '18');
INSERT INTO `c_role_security` VALUES ('112', '1', '19');
INSERT INTO `c_role_security` VALUES ('113', '1', '20');
INSERT INTO `c_role_security` VALUES ('114', '1', '21');
INSERT INTO `c_role_security` VALUES ('115', '1', '22');
INSERT INTO `c_role_security` VALUES ('116', '1', '23');
INSERT INTO `c_role_security` VALUES ('117', '1', '24');
INSERT INTO `c_role_security` VALUES ('118', '1', '25');
INSERT INTO `c_role_security` VALUES ('119', '1', '26');
INSERT INTO `c_role_security` VALUES ('120', '1', '27');
INSERT INTO `c_role_security` VALUES ('121', '1', '28');
INSERT INTO `c_role_security` VALUES ('122', '1', '29');
INSERT INTO `c_role_security` VALUES ('123', '1', '30');
INSERT INTO `c_role_security` VALUES ('124', '1', '31');
INSERT INTO `c_role_security` VALUES ('125', '1', '32');
INSERT INTO `c_role_security` VALUES ('126', '1', '33');
INSERT INTO `c_role_security` VALUES ('127', '1', '34');
INSERT INTO `c_role_security` VALUES ('128', '1', '35');
INSERT INTO `c_role_security` VALUES ('129', '1', '36');
INSERT INTO `c_role_security` VALUES ('130', '1', '37');
INSERT INTO `c_role_security` VALUES ('131', '1', '38');
INSERT INTO `c_role_security` VALUES ('132', '1', '39');
INSERT INTO `c_role_security` VALUES ('133', '1', '40');
INSERT INTO `c_role_security` VALUES ('134', '1', '41');
INSERT INTO `c_role_security` VALUES ('135', '1', '42');
INSERT INTO `c_role_security` VALUES ('136', '1', '43');
INSERT INTO `c_role_security` VALUES ('137', '1', '44');
...
CREATE TABLE `c_security` (
  ...
  `desc` varchar(255) DEFAULT NULL COMMENT '权限说明',
  PRIMARY KEY (`id`),
...
-- ----------------------------
INSERT INTO `c_security` VALUES ('1', '0', '1', '系统权限', 'root', null);
INSERT INTO `c_security` VALUES ('2', '1', '1', '系统设置', 'system', '');
INSERT INTO `c_security` VALUES ('3', '2', '1', '用户管理', 'system/user', '');
INSERT INTO `c_security` VALUES ('4', '1', '1', '广告管理', 'advertisement', null);
INSERT INTO `c_security` VALUES ('5', '1', '1', '订单管理', 'order', null);
INSERT INTO `c_security` VALUES ('6', '1', '1', '新品管理', 'product', null);
INSERT INTO `c_security` VALUES ('7', '2', '1', '管理员管理', 'system/admin', '管理员管理');
INSERT INTO `c_security` VALUES ('8', '1', '1', '待发货管理', 'shipOrder', '待发货管理');
INSERT INTO `c_security` VALUES ('9', '1', '1', '包裹管理', 'packOrder', '包裹管理');
INSERT INTO `c_security` VALUES ('14', '5', '1', '订单增加', 'order/insert', '订单增加');
INSERT INTO `c_security` VALUES ('15', '5', '1', '订单修改', 'order/update', '订单修改');
INSERT INTO `c_security` VALUES ('16', '5', '1', '订单查询', 'order/search', '订单查询详情');
INSERT INTO `c_security` VALUES ('17', '5', '1', '订单删除', 'order/delete', '订单删除');
INSERT INTO `c_security` VALUES ('18', '8', '1', '待发货查询', 'shipOrder/search', '包裹查询');
INSERT INTO `c_security` VALUES ('19', '8', '1', '待发货修改', 'shipOrder/update', '待发货修改');
INSERT INTO `c_security` VALUES ('20', '8', '1', '待发货增加', 'shipOrder/insert', '待发货增加');
INSERT INTO `c_security` VALUES ('21', '8', '1', '待发货删除', 'shipOrder/delete', '待发货删除');
INSERT INTO `c_security` VALUES ('22', '9', '1', '包裹查询', 'packOrder/search', '包裹查询');
INSERT INTO `c_security` VALUES ('23', '9', '1', '包裹修改', 'packOrder/update', '包裹修改');
INSERT INTO `c_security` VALUES ('24', '9', '1', '包裹删除', 'packOrder/delete', '包裹删除');
INSERT INTO `c_security` VALUES ('25', '9', '1', '包裹增加', 'packOrder/insert', '包裹增加');
INSERT INTO `c_security` VALUES ('26', '2', '1', '系统参数管理', 'system/parameter', null);
INSERT INTO `c_security` VALUES ('27', '2', '1', '系统角色管理', 'system/role', null);
INSERT INTO `c_security` VALUES ('28', '2', '1', '系统权限管理', 'system/security', null);
INSERT INTO `c_security` VALUES ('29', '2', '1', '自提地址管理', 'system/pickup', null);
INSERT INTO `c_security` VALUES ('30', '1', '1', '单品管理', 'productItem', null);
INSERT INTO `c_security` VALUES ('31', '30', '1', '单品查询', 'productItem/search', null);
INSERT INTO `c_security` VALUES ('32', '30', '1', '单品增加', 'productItem/insert', null);
INSERT INTO `c_security` VALUES ('33', '30', '1', '单品修改', 'productItem/update', null);
INSERT INTO `c_security` VALUES ('34', '30', '1', '单品删除', 'productItem/delete', null);
INSERT INTO `c_security` VALUES ('35', '30', '1', '单品类别', 'productItem/category', '类别增、删、查、改');
INSERT INTO `c_security` VALUES ('36', '6', '1', '新品查询', 'product/search', null);
INSERT INTO `c_security` VALUES ('37', '6', '1', '新品增加', 'product/insert', null);
INSERT INTO `c_security` VALUES ('38', '6', '1', '新品修改', 'product/update', null);
INSERT INTO `c_security` VALUES ('39', '6', '1', '新品删除', 'product/delete', null);
INSERT INTO `c_security` VALUES ('40', '6', '1', '新品系列', 'product/series', '系列增、删、查、改');
INSERT INTO `c_security` VALUES ('41', '6', '1', '新品类别', 'product/category', '类别增、删、查、改');
INSERT INTO `c_security` VALUES ('42', '1', '1', '供应商管理', 'supplier', null);
INSERT INTO `c_security` VALUES ('43', '2', '1', '快递公司管理', 'system/delivery', null);
INSERT INTO `c_security` VALUES ('44', '2', '1', '特殊用户管理', 'system/userColor', '特殊用户管理');
...
-- ----------------------------
DROP TABLE IF EXISTS `t_society_sub`;
